        ...
        <section className="flex flex-col w-full justify-center h-fit pt-5">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 w-full gap-5 h-fit mb-10">
                {produkList.map((item, i) => (
                    <div className="w-full relative" key={i}>
                        <Image loading="lazy"src={item.name} width={500} height={500} alt="Produk list" className="h-[40vh] md:h-[60vh] w-full object-cover rounded-xl" />
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-5">
                <div className="h-[80vh] w-full relative flex">
                    <Image loading="lazy"width={500} height={500} src='https://www.ikea.com/global/en/images/PH_199178_7298adbed8.jpg?f=xxxl' alt="produk-img" className="w-full h-full object-cover rounded-xl" />
                ...
                <div className="h-[80vh] w-full relative flex">
                    <Image loading="lazy"width={500} height={500} src='https://www.ikea.com/global/en/images/Bedroom_1971_1b40a9c63c.jpg?f=xxxl' alt="produk-img" className="w-full h-full object-cover rounded-xl" />
