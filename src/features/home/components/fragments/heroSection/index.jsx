...
const HeroSection = () => {
    ...
    return (
        <section className="w-full h-full flex justify-center items-center mt-[60px] md:mt-[98px] relative">
            <Image height={500} width={500} id="slide-image" src={imagesArray[currentIndex].img} alt="banner-brand" className="rounded-xl w-full h-[300px] md:h-[500px] object-cover" />
