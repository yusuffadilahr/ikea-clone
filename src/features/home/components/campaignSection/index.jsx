        ...
        <section className='w-full h-fit md:h-[600px] flex flex-col md:flex-row gap-5 pt-5 pb-5'>
            <div className="flex w-full h-full">
                <div className="flex relative w-full h-full">
                    <Image loading="lazy" src={'https://www.ikea.com/global/en/images/PH_198830_49466cdb3e.jpg?f=sg'} width={1000} height={1000} alt="img-banner" className="w-full h-[60vh] md:h-full object-cover rounded-xl" />
