      ...
      <section className="flex flex-col w-full justify-center h-fit pt-5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 w-full gap-5">
          <div className="h-[80vh] w-full relative flex">
            <Image width={500} height={500} alt='logs' src='https://www.ikea.com/global/en/images/PH_199178_7298adbed8.jpg?f=xxxl' alt="produk-img" className="w-full h-full object-cover rounded-xl" />
      ...
      <section className="w-full h-fit pt-2">
        ...
        <div className="w-full h-fit md:h-fit flex flex-col gap-5 lg:gap-0 md:flex md:flex-row">
          ...
          <div className="w-full md:w-1/2 lg:w-full h-full">
            <img src='https://www.ikea.com/ext/ingkadam/m/558f842846a6fa1b/original/PX000263-crop002.jpg?f=m' alt="about-section" className="w-full md:w-fit lg:w-full h-[70vh] object-left object-cover" />
          </div>
        </div>
        <div className="w-full flex mt-10 px-2 lg:px-10">
          <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-5">
            <div>
              <img src='https://www.ikea.com/ext/ingkadam/m/c391306500d28d8/original/PE117762-crop001.jpg?f=m' alt="about-section" className="w-full h-[80vh] object-cover" />
            </div>
