            ...
            <main className={`w-full h-fit flex flex-col ${px} mt-14`}>
                ...
                <section className='w-full h-fit flex-col justify-center flex'>
                    <div className='flex justify-center h-fit pt-20 w-full flex-col items-center'>
                        <h1 className='text-7xl font-bold'>The Story of IKEA {year}</h1>
                ...
                <section className={`w-full h-fit pt-2 mt-24 ${hiddenContent}`}>
                    ...
                    <div className='w-full px-60 h-fit flex flex-col justify-center mt-20 items-center mb-36'>
                    ...
                    <div className='w-full h-96 flex px-20 mb-20'>
                        <div className='flex-col gap-5 bg-yellow-400 flex justify-center items-center w-full h-full rounded-xl'>
                            <p className='max-w-[50%] text-lg flex justify-normal w-full'>Did you know?</p>
                            <p className='max-w-[50%] text-2xl'>IKEA is named after the initials of founder <span className='font-bold'>I</span>ngvar <span className='font-bold'>K</span>amprad, <span className='font-bold'>E</span>lmtaryd, the farm on which he grew up, and <span className='font-bold'>A</span>gunnaryd, the nearby village.</p>
                        </div>
                    </div>
                    <div className="w-full flex mt-32 px-2 lg:px-20 mb-32">
                        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-5">
                            <div className='w-[80%]'>
                                <Image width={500} height={500} src={'https://www.ikea.com/global/en/images/ikea_early_beginnings_green_shed_elmtaryd_sweden_1940s_1600x900_85425134bf.jpg?f=sg'} alt="about-section" className="w-full rounded-xl h-[80vh] object-cover" />
                            </div>
                            <div className="flex flex-col gap-8 justify-center items-center w-full">
                                <h1 className="flex max-w-[65%] w-full justify-normal text-4xl font-bold">Humble beginnings</h1>
                    ...
                    <div className="w-full flex mt-10 px-2 lg:px-20 mb-20">
                        <div className="w-full h-full grid grid-cols-1 md:grid-cols-2 gap-5">
