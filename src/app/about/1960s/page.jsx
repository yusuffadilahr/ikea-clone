...
import CardGridResponsive from '@/components/core/cardContent/cardGridResponsive'
        ...
        <AboutPage pxSelect='px-5' hiddenContent='hidden' px='0' year={pathName}>
            <main className='w-full md:mt-10 h-fit flex flex-col justify-center items-center'>
                ...
                <CardGridResponsive>
                    ...
                    <div className='md:hidden grid grid-cols-2 gap-3'>
                        <div className='flex flex-col'>
                            <Image loading="lazy" alt='history' src={'https://ikeamuseum.com/wp-content/uploads/2021/06/im-1960-interiors-01-ft-768x576.jpg?sv=2022-11-02&ss=bf&srt=o&sp=rwact&se=2032-07-19T20:53:53Z&st=2023-07-19T00:53:53Z&spr=https,http&sig=CbW5rmYp6FrCBT77fuGZVaQIyQ6kOS0Coe6AbA3prrw%3D'} width={1000} height={1000} className='rounded-xl object-cover h-[20vh] w-full flex' />
                            <h1 className='font-bold text-sm py-2'>Life at home 1970s</h1>
                        </div>
                        <div className='flex flex-col'>
                            <Image loading="lazy" alt='history' src={'https://ikeamuseum.com/wp-content/uploads/2023/06/1960-1-768x576.jpg?sv=2022-11-02&ss=bf&srt=o&sp=rwact&se=2032-07-19T20:53:53Z&st=2023-07-19T00:53:53Z&spr=https,http&sig=CbW5rmYp6FrCBT77fuGZVaQIyQ6kOS0Coe6AbA3prrw%3D'} width={1000} height={1000} className='rounded-xl object-cover h-[20vh] w-full flex' />
                            <h1 className='font-bold md:text-lg text-sm py-2'>1970s IKEA catalogues</h1>
                        </div>
                    </div>

                    <div className='flex flex-col h-[40vh]'>
                        <Image loading="lazy" alt='history' src={'https://ikeamuseum.com/wp-content/uploads/2021/05/fd-1960s-productstories-featured-768x576.jpg?sv=2022-11-02&ss=bf&srt=o&sp=rwact&se=2032-07-19T20:53:53Z&st=2023-07-19T00:53:53Z&spr=https,http&sig=CbW5rmYp6FrCBT77fuGZVaQIyQ6kOS0Coe6AbA3prrw%3D'} width={2000} height={2000} className='rounded-xl object-cover md:h-[30vh] h-[50vh] w-full flex' />
                ...
                <VideoContent
                    ...
                    title='The political 60s'
                    descShort='The world is rocked by ideological conflict. In Sweden, social reforms improve living standards. A building boom creates a need for home furnishings and an IKEA flagship store opens in Stockholm.'
                    video='https://ikeamuseum.com/wp-content/uploads/2021/05/IKEA_60s_ENG_MASTER_03_SUB_1.mp4?sv=2022-11-02&ss=bf&srt=o&sp=rwact&se=2032-07-19T20:53:53Z&st=2023-07-19T00:53:53Z&spr=https,http&sig=CbW5rmYp6FrCBT77fuGZVaQIyQ6kOS0Coe6AbA3prrw%3D'
                />
                            ...
                            {historyData.map((history, i) => (
                                <div className='flex justify-start px-4 lg:px-0 flex-row gap-5 items-center w-full' key={i}>
                                    <div className='w-full flex justify-center'>
                                        <Image loading="lazy" alt='history' src={history.imageUrl} width={1000} height={1000} className='rounded-xl object-cover w-full lg:w-[70%] h-[20vh] flex' />
                                    </div>
