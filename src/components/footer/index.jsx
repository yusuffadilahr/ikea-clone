...
const FooterCustom = () => {
    return (
        <footer className="bottom-0 h-fit w-full mt-10">
            <div className="w-full flex justify-center items-center flex-col gap-10 mb-20">
                ...
                <img src="https://www.ikea.com/global/assets/logos/brand/ikea.svg" alt="logo-company" className='w-20 md:w-[150px] ml-5' />
            </div>
            <img src='https://www.ikea.com/global/en/images/footer-illustration.svg' alt="" className='w-full h-fit'/>
